# Generated by Django 2.2.2 on 2020-05-03 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', smartfields.fields.ImageField(upload_to='news/images/articles', verbose_name='Изображение')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True)),
                ('slug', models.SlugField(blank=True, max_length=150, unique=True)),
                ('image', smartfields.fields.ImageField(upload_to='news/images/news', verbose_name='Изображение')),
            ],
            options={
