...
from .views import ArticleShortListView, ArticleDetailView, \
    ...
    ArticleListView, NewsListView

urlpatterns = [
    path('article_short_list/', ArticleShortListView.as_view(), name='article_short_list_api'),
    ...
    path('news_short_list/', NewsShortListView.as_view(), name='news_short_list_api'),
